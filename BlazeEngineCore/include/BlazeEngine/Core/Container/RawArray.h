	...
	public:
		...
		*/
		...
		/*
			...
			pointing to.
		*/
		template<typename F> requires std::invocable<F, typename RawArray<T, Allocator>::StoredType*, uintMem>
		...
		*/
		template<typename ... Args> requires IsConstructibleFrom<typename RawArray<T, Allocator>::StoredType, Args...>
		...
		*/
		template<typename T2, uintMem S> requires IsConstructibleFrom<typename RawArray<T, Allocator>::StoredType, const T2&>
		...
		*/
		template<typename T2> requires IsConstructibleFrom<typename RawArray<T, Allocator>::StoredType, const T2&>
