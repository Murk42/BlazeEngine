...
namespace Blaze
{
	...
	*/
	...
	public:
		...
		*/
		Array(const Array& other) requires std::copy_constructible<typename Array<T, Allocator>::StoredType >;
		/*
		...
		*/
		...
		/*
			...
			This constructor is only available if the value type is copy-constructible or is a reference type.
		*/
		Array(const ArrayView<T>& other) requires std::copy_constructible<typename Array<T, Allocator>::StoredType >;
		/*
		...
		*/
		Array(const StoredType* begin, const StoredType* end) requires std::copy_constructible<typename Array<T, Allocator>::StoredType >;
		/*
			Copy-constructs the array from a range limited by the begin and end iterators. The new array will
			copy each element individually. If either of the iterators in null an empty array is created. This
			constructor is only available if the value type is copy-constructible or is a reference type.
		*/
		Array(Iterator begin, Iterator end) requires std::copy_constructible<typename Array<T, Allocator>::StoredType >;
		/*
		...
		*/
		...
		/*
			...
			allocating new memory
		*/
		void ReserveAdditional(uintMem reserveCount) requires IsConstructibleFrom<T, T&&>;
		...
		*/
		...
		/*
			\return A pointer to the buffer of stored elements
		*/
		const StoredType* Begin() const;
		/*
			\return A pointer pointing behind the last element in the buffer
		*/
		StoredType* End();
		/*
			\return A pointer pointing behind the last element in the buffer
		*/
		const StoredType* End() const;
		...
		*/
		...
		/*
			...
			returns false
		*/
		bool operator==(const ArrayView<T>& other) const requires std::equality_comparable<typename Array<T, Allocator>::StoredType>;
		/*
			Compares the arrays. This function is only available if the value type is comparable, or if the
			value type is a reference type.
		...
		*/
		Array& operator=(const Array& other) requires std::copy_constructible<typename Array<T, Allocator>::StoredType> && std::assignable_from<typename Array<T, Allocator>::StoredType&, const typename Array<T, Allocator>::StoredType&>;
		/*
