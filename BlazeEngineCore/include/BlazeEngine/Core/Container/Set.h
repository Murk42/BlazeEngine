...
namespace Blaze
{
	...
	concept IsConvertibleToSetIterator =
		SameAs<RemoveConst<typename T2::SetType>, RemoveConst<typename T1::SetType>> &&
		(!(IsConstType<typename T1::SetType> && !IsConstType<typename T2::SetType>));
	...
	*/
	...
	class BLAZE_API SetIterator
	{
	public:
		using SetType = Set;
		using ValueType = Conditional<IsConstType<Set>, const typename Set::ValueType, typename Set::ValueType>;
	...
	private:
		using Node = Conditional<IsConstType<Set>, const typename Set::Node, typename Set::Node>;
		using Bucket = Conditional<IsConstType<Set>, const typename Set::Bucket, typename Set::Bucket>;
	...
	*/
	...
	public:
		...
		*/
		...
		InsertResult Insert(Args&& ... args) requires IsConstructibleFrom<Value, Value&&>;
