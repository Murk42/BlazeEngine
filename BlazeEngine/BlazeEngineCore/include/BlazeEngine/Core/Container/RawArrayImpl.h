...
namespace Blaze
{
	...
	template<typename T, AllocatorType Allocator> requires std::is_trivially_destructible_v<T>
	template<typename ...Args> requires IsConstructibleFrom<typename RawArray<T, Allocator>::template StoredType, Args...>
	...
	template<typename T, AllocatorType Allocator> requires std::is_trivially_destructible_v<T>
	template<typename T2, uintMem S> requires IsConstructibleFrom<typename RawArray<T, Allocator>::template StoredType, const T2&>
	...
	template<typename T, AllocatorType Allocator> requires std::is_trivially_destructible_v<T>
	template<typename T2> requires IsConstructibleFrom<typename RawArray<T, Allocator>::template StoredType, const T2&>
	...
	template<typename T, AllocatorType Allocator> requires std::is_trivially_destructible_v<T>
	template<typename T2, AllocatorType Allocator2> requires IsConstructibleFrom<typename Array<T, Allocator>::template StoredType, const T2&>
	...
	template<typename T, AllocatorType Allocator> requires std::is_trivially_destructible_v<T>
	template<typename T2> requires IsConstructibleFrom<typename Array<T, Allocator>::template StoredType, const T2&>
	...
	inline T& RawArray<T, Allocator>::operator[](uintMem i)
	{
		...
		if (ptr == nullptr)
			BLAZE_LOG_FATAL("Accessing a empty RawArray");
#endif
	...
	template<typename T, AllocatorType Allocator> requires std::is_trivially_destructible_v<T>
	template<typename T2, AllocatorType Allocator2>  requires IsConstructibleFrom<typename Array<T, Allocator>::template StoredType, const T2&>&& std::assignable_from<typename Array<T, Allocator>::template StoredType&, const T2&>
	...
	template<typename T, AllocatorType Allocator> requires std::is_trivially_destructible_v<T>
	template<typename T2>  requires IsConstructibleFrom<typename Array<T, Allocator>::template StoredType, const T2&>&& std::assignable_from<typename Array<T, Allocator>::template StoredType&, const T2&>
