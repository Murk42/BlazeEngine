...
{
	Bitmap MonochromeFontGlyphRenderer::Render(const Font& font, uint fontPixelHeight, UnicodeChar character)
	{
	...
	Bitmap AntialiasedFontGlyphRenderer::Render(const Font& font, uint fontPixelHeight, UnicodeChar character)
	{
		FT_Face face = (FT_Face)font.GetHandle();
		FT_Set_Pixel_Sizes(face, 0, fontPixelHeight);
		uint glyphIndex = FT_Get_Char_Index(face, character.Value());
	...
	Bitmap HorizontalLCDFontGlyphRenderer::Render(const Font& font, uint fontPixelHeight, UnicodeChar character)
	{
		FT_Face face = (FT_Face)font.GetHandle();
		FT_Set_Pixel_Sizes(face, 0, fontPixelHeight);
		uint glyphIndex = FT_Get_Char_Index(face, character.Value());
	...
	Bitmap VerticalLCDFontGlyphRenderer::Render(const Font& font, uint fontPixelHeight, UnicodeChar character)
	{
		FT_Face face = (FT_Face)font.GetHandle();
		FT_Set_Pixel_Sizes(face, 0, fontPixelHeight);
		uint glyphIndex = FT_Get_Char_Index(face, character.Value());
	...
	Bitmap SDFFontGlyphRenderer::Render(const Font& font, uint fontPixelHeight, UnicodeChar character)
	{
		FT_Face face = (FT_Face)font.GetHandle();
		FT_Set_Pixel_Sizes(face, 0, fontPixelHeight);
		uint glyphIndex = FT_Get_Char_Index(face, character.Value());
	...
	Bitmap MSDFFontGlyphRenderer::Render(const Font& font, uint fontPixelHeight, UnicodeChar character)
	{
