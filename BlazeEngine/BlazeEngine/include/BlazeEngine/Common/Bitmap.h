...
namespace Blaze
{
	...
	public:
		...
		BitmapRef SubBitmap(Vec2u size, Vec2u offset);
	...
	public:
		...
		bool LoadWithMIME(ReadStream& stream, u8String imageMIMEType, bool flipVertically = false);
		bool LoadWithExtension(ReadStream& stream, u8String extension, bool flipVertically = false);
		bool Save(Path path);
		bool Save(WriteStream& stream, u8String imageType);
	...
	public:
		...
		BitmapView SubBitmap(Vec2u size, Vec2u offset);
