...
namespace Blaze
{
		...
		: graphicsAPI(WindowGraphicsAPI::None), handle(nullptr), context(context)
	{
		...
		if (SDL_SetBooleanProperty(properties, SDL_PROP_WINDOW_CREATE_RESIZABLE_BOOLEAN, createOptions.resizable) == false)
			BLAZE_LOG_FATAL("Calling SDL_SetBooleanProperty with SDL_PROP_WINDOW_CREATE_RESIZABLE_BOOLEAN failed. SDL returned error: \"" + GetSDLError() + "\"");
		if (SDL_SetBooleanProperty(properties, SDL_PROP_WINDOW_CREATE_BORDERLESS_BOOLEAN, createOptions.borderless) == false)
			BLAZE_LOG_FATAL("Calling SDL_SetBooleanProperty with SDL_PROP_WINDOW_CREATE_BORDERLESS_BOOLEAN failed. SDL returned error: \"" + GetSDLError() + "\"");
		if (SDL_SetBooleanProperty(properties, SDL_PROP_WINDOW_CREATE_MOUSE_GRABBED_BOOLEAN, createOptions.mouseGrabbed) == false)
			BLAZE_LOG_FATAL("Calling SDL_SetBooleanProperty with SDL_PROP_WINDOW_CREATE_MOUSE_GRABBED_BOOLEAN failed. SDL returned error: \"" + GetSDLError() + "\"");
		if (SDL_SetBooleanProperty(properties, SDL_PROP_WINDOW_CREATE_FOCUSABLE_BOOLEAN, createOptions.focusable) == false)
			BLAZE_LOG_FATAL("Calling SDL_SetBooleanProperty with SDL_PROP_WINDOW_CREATE_FOCUSABLE_BOOLEAN failed. SDL returned error: \"" + GetSDLError() + "\"");
		if (SDL_SetBooleanProperty(properties, SDL_PROP_WINDOW_CREATE_HIDDEN_BOOLEAN, createOptions.hidden) == false)
			BLAZE_LOG_FATAL("Calling SDL_SetBooleanProperty with SDL_PROP_WINDOW_CREATE_HIDDEN_BOOLEAN failed. SDL returned error: \"" + GetSDLError() + "\"");
		if (SDL_SetBooleanProperty(properties, SDL_PROP_WINDOW_CREATE_TRANSPARENT_BOOLEAN, createOptions.transparent) == false)
			BLAZE_LOG_FATAL("Calling SDL_SetBooleanProperty with SDL_PROP_WINDOW_CREATE_TRANSPARENT_BOOLEAN failed. SDL returned error: \"" + GetSDLError() + "\"");
		if (SDL_SetBooleanProperty(properties, SDL_PROP_WINDOW_CREATE_HIGH_PIXEL_DENSITY_BOOLEAN, createOptions.highPixelDensity) == false)
			BLAZE_LOG_FATAL("Calling SDL_SetBooleanProperty with SDL_PROP_WINDOW_CREATE_HIGH_PIXEL_DENSITY_BOOLEAN failed. SDL returned error: \"" + GetSDLError() + "\"");
		if (SDL_SetBooleanProperty(properties, SDL_PROP_WINDOW_CREATE_ALWAYS_ON_TOP_BOOLEAN, createOptions.alwaysOnTop) == false)
			BLAZE_LOG_FATAL("Calling SDL_SetBooleanProperty with SDL_PROP_WINDOW_CREATE_ALWAYS_ON_TOP_BOOLEAN failed. SDL returned error: \"" + GetSDLError() + "\"");
		if (SDL_SetBooleanProperty(properties, SDL_PROP_WINDOW_CREATE_UTILITY_BOOLEAN, createOptions.utilityWindow) == false)
			BLAZE_LOG_FATAL("Calling SDL_SetBooleanProperty with SDL_PROP_WINDOW_CREATE_UTILITY_BOOLEAN failed. SDL returned error: \"" + GetSDLError() + "\"");
		...
		if (SDL_SetPointerProperty(properties, SDL_PROP_WINDOW_CREATE_PARENT_POINTER, createOptions.parentWindow == nullptr ? nullptr : createOptions.parentWindow->GetHandle()) == false)
			BLAZE_LOG_FATAL("Calling SDL_SetPointerProperty with SDL_PROP_WINDOW_CREATE_PARENT_POINTER failed. SDL returned error: \"" + GetSDLError() + "\"");
		...
		if (SDL_SetStringProperty(properties, SDL_PROP_WINDOW_CREATE_TITLE_STRING, reinterpret_cast<const char*>(createOptions.title.Ptr())) == false)
			BLAZE_LOG_FATAL("Calling SDL_SetStringProperty with SDL_PROP_WINDOW_CREATE_TITLE_STRING failed. SDL returned error: \"" + GetSDLError() + "\"");
		if (SDL_SetNumberProperty(properties, SDL_PROP_WINDOW_CREATE_X_NUMBER, pos.x) == false)
			BLAZE_LOG_FATAL("Calling SDL_SetNumberProperty with SDL_PROP_WINDOW_CREATE_X_NUMBER failed. SDL returned error: \"" + GetSDLError() + "\"");
		if (SDL_SetNumberProperty(properties, SDL_PROP_WINDOW_CREATE_Y_NUMBER, pos.y) == false)
			BLAZE_LOG_FATAL("Calling SDL_SetNumberProperty with SDL_PROP_WINDOW_CREATE_Y_NUMBER failed. SDL returned error: \"" + GetSDLError() + "\"");
		if (SDL_SetNumberProperty(properties, SDL_PROP_WINDOW_CREATE_WIDTH_NUMBER, createOptions.size.x) == false)
			BLAZE_LOG_FATAL("Calling SDL_SetNumberProperty with SDL_PROP_WINDOW_CREATE_WIDTH_NUMBER failed. SDL returned error: \"" + GetSDLError() + "\"");
		if (SDL_SetNumberProperty(properties, SDL_PROP_WINDOW_CREATE_HEIGHT_NUMBER, createOptions.size.y) == false)
			BLAZE_LOG_FATAL("Calling SDL_SetNumberProperty with SDL_PROP_WINDOW_CREATE_HEIGHT_NUMBER failed. SDL returned error: \"" + GetSDLError() + "\"");

		if (SDL_SetBooleanProperty(properties, SDL_PROP_WINDOW_CREATE_FULLSCREEN_BOOLEAN, fullscreen) == false)
			BLAZE_LOG_FATAL("Calling SDL_SetBooleanProperty with SDL_PROP_WINDOW_CREATE_FULLSCREEN_BOOLEAN failed. SDL returned error: \"" + GetSDLError() + "\"");
		if (SDL_SetBooleanProperty(properties, SDL_PROP_WINDOW_CREATE_MAXIMIZED_BOOLEAN, maximized) == false)
			BLAZE_LOG_FATAL("Calling SDL_SetBooleanProperty with SDL_PROP_WINDOW_CREATE_MAXIMIZED_BOOLEAN failed. SDL returned error: \"" + GetSDLError() + "\"");
		if (SDL_SetBooleanProperty(properties, SDL_PROP_WINDOW_CREATE_MINIMIZED_BOOLEAN, minimized) == false)
			BLAZE_LOG_FATAL("Calling SDL_SetBooleanProperty with SDL_PROP_WINDOW_CREATE_MINIMIZED_BOOLEAN failed. SDL returned error: \"" + GetSDLError() + "\"");

		if (SDL_SetBooleanProperty(properties, SDL_PROP_WINDOW_CREATE_METAL_BOOLEAN, metal) == false)
			BLAZE_LOG_FATAL("Calling SDL_SetBooleanProperty with SDL_PROP_WINDOW_CREATE_METAL_BOOLEAN failed. SDL returned error: \"" + GetSDLError() + "\"");
		if (SDL_SetBooleanProperty(properties, SDL_PROP_WINDOW_CREATE_OPENGL_BOOLEAN, opengl) == false)
			BLAZE_LOG_FATAL("Calling SDL_SetBooleanProperty with SDL_PROP_WINDOW_CREATE_OPENGL_BOOLEAN failed. SDL returned error: \"" + GetSDLError() + "\"");
		if (SDL_SetBooleanProperty(properties, SDL_PROP_WINDOW_CREATE_VULKAN_BOOLEAN, vulkan) == false)
			BLAZE_LOG_FATAL("Calling SDL_SetBooleanProperty with SDL_PROP_WINDOW_CREATE_VULKAN_BOOLEAN failed. SDL returned error: \"" + GetSDLError() + "\"");
		...
		if (handle == nullptr)
			BLAZE_LOG_FATAL("Failed to create a SDL window. SDL returned error: \"" + GetSDLError() + "\"");
	...
	void Window::SetTitle(u8StringView title)
	{
		...
		if (!SDL_SetWindowTitle((SDL_Window*)handle, reinterpret_cast<const char*>(u8String(title).Ptr())))
			BLAZE_LOG_ERROR("SDL_SetWindowTitle failed. SDL returned error: \"{}\"", GetSDLError());
	}
	Vec2i Window::GetPos() const
	{
		...
		if (!SDL_GetWindowPosition((SDL_Window*)handle, &pos.x, &pos.y))
			BLAZE_LOG_ERROR("SDL_GetWindowPosition failed. SDL returned error: \"" + GetSDLError() + "\"");
	...
	void Window::SetPos(Vec2i pos)
	{
		...
		if (!SDL_SetWindowPosition((SDL_Window*)handle, pos.x, pos.y))
			BLAZE_LOG_ERROR("SDL_SetWindowPosition failed. SDL returned error: \"" + GetSDLError() + "\"");
	}
	Vec2u Window::GetSize() const
	{
		...
		if (!SDL_GetWindowSize((SDL_Window*)handle, reinterpret_cast<int*>(&size.x), reinterpret_cast<int*>(&size.y)))
			BLAZE_LOG_ERROR("SDL_GetWindowSize failed. SDL returned error: \"" + GetSDLError() + "\"");
	...
	void Window::SetSize(Vec2u s)
	{
		...
		if (!SDL_SetWindowSize((SDL_Window*)handle, s.x, s.y))
			BLAZE_LOG_ERROR("SDL_GetWindowSizeInPixels failed. SDL returned error: \"" + GetSDLError() + "\"");
	}
	...
	void Window::SetResizableFlag(bool resizable)
	{
		...
		if (!SDL_SetWindowResizable((SDL_Window*)handle, resizable))
			BLAZE_LOG_ERROR("SDL_SetWindowResizable failed. SDL returned error: \"" + GetSDLError() + "\"");
	}
	...
	void Window::SetMouseGrabbedFlag(bool grabbed)
	{
		...
		if (!SDL_SetWindowMouseGrab((SDL_Window*)handle, grabbed))
			BLAZE_LOG_ERROR("SDL_SetWindowMouseGrab failed. SDL returned error: \"" + GetSDLError() + "\"");
	}
	...
	void Window::SetFocusableFlag(bool focusable)
	{
		...
		if (!SDL_SetWindowFocusable((SDL_Window*)handle, focusable))
			BLAZE_LOG_ERROR("SDL_SetWindowFocusable failed. SDL returned error: \"" + GetSDLError() + "\"");
	}
	...
	void Window::SetAlwaysOnTopFlag(bool alwaysOnTop)
	{
		...
		if (!SDL_SetWindowAlwaysOnTop((SDL_Window*)handle, alwaysOnTop))
			BLAZE_LOG_ERROR("SDL_SetWindowAlwaysOnTop failed. SDL returned error: \"" + GetSDLError() + "\"");
	}
	...
	void Window::SetBorderlessFlag(bool borderless)
	{
		...
		if (!SDL_SetWindowBordered((SDL_Window*)handle, !borderless))
			BLAZE_LOG_ERROR("SDL_SetWindowBordered failed. SDL returned error: \"" + GetSDLError() + "\"");
	}
	...
	void Window::SetHiddenFlag(bool hidden)
	{
		...
		if (hidden)
		{
			if (!SDL_HideWindow((SDL_Window*)handle))
				BLAZE_LOG_ERROR("SDL_HideWindow failed. SDL returned error: \"" + GetSDLError() + "\"");
		}
		else
			if (!SDL_ShowWindow((SDL_Window*)handle))
				BLAZE_LOG_ERROR("SDL_ShowWindow failed. SDL returned error: \"" + GetSDLError() + "\"");
	}
	...
	void Window::SetWindowPresentMode(WindowPresentMode presentMode)
	{
		...
		case Blaze::WindowPresentMode::Fullscreen:
			if (!SDL_SetWindowFullscreen((SDL_Window*)handle, true))
				BLAZE_LOG_ERROR("SDL_SetWindowFullscreen failed. SDL returned error: \"" + GetSDLError() + "\"");
			break;
		case Blaze::WindowPresentMode::Maximized:
			...
			if (!SDL_MaximizeWindow((SDL_Window*)handle))
				BLAZE_LOG_ERROR("SDL_MaximizeWindow failed. SDL returned error: \"" + GetSDLError() + "\"");
			break;
		case Blaze::WindowPresentMode::Minimized:
			...
			if (!SDL_MinimizeWindow((SDL_Window*)handle))
				BLAZE_LOG_ERROR("SDL_MinimizeWindow failed. SDL returned error: \"" + GetSDLError() + "\"");
			break;
		case Blaze::WindowPresentMode::Normal:
			...
			if (!SDL_RestoreWindow((SDL_Window*)handle))
				BLAZE_LOG_ERROR("SDL_RestoreWindow failed. SDL returned error: \"" + GetSDLError() + "\"");
			break;
		default:
			break;
		}
	...
	void Window::GetMinAndMaxAspectRatio(float& min, float& max)
	{
		...
		if (!SDL_GetWindowAspectRatio((SDL_Window*)handle, &min, &max))
			BLAZE_LOG_ERROR("SDL_GetWindowAspectRatio failed. SDL returned error: \"" + GetSDLError() + "\"");
	}
	void Window::SetMinAndMaxAspectRatio(float min, float max)
	{
		...
		if (!SDL_SetWindowAspectRatio((SDL_Window*)handle, min, max))
			BLAZE_LOG_ERROR("SDL_SetWindowAspectRatio failed. SDL returned error: \"" + GetSDLError() + "\"");
	}
	...
	void Window::SetOpacity(float opacity)
	{
		...
		if (!SDL_SetWindowOpacity((SDL_Window*)handle, opacity))
			BLAZE_LOG_ERROR("SDL_SetWindowOpacity failed. SDL returned error: \"" + GetSDLError() + "\"");
	}
	Vec2u Window::GetMinimumSize() const
	{
		...
		if (!SDL_GetWindowMinimumSize((SDL_Window*)handle, (int*)&minimumSize.x, (int*)&minimumSize.y))
			BLAZE_LOG_ERROR("SDL_GetWindowMinimumSize failed. SDL returned error: \"" + GetSDLError() + "\"");
		return minimumSize;
	}
	void Window::SetMinimumSize(Vec2u size)
	{
		...
		if (!SDL_SetWindowMinimumSize((SDL_Window*)handle, size.x, size.y))
			BLAZE_LOG_ERROR("SDL_SetWindowMinimumSize failed. SDL returned error: \"" + GetSDLError() + "\"");
	}
	Vec2u Window::GetMaximumSize() const
	{
		...
		if (!SDL_GetWindowMaximumSize((SDL_Window*)handle, (int*)&maximumSize.x, (int*)&maximumSize.y))
			BLAZE_LOG_ERROR("SDL_GetWindowMaximumSize failed. SDL returned error: \"" + GetSDLError() + "\"");
		return maximumSize;
	}
	void Window::SetMaximumSize(Vec2u size)
	{
		...
		if (!SDL_SetWindowMaximumSize((SDL_Window*)handle, size.x, size.y))
			BLAZE_LOG_ERROR("SDL_SetWindowMaximumSize failed. SDL returned error: \"" + GetSDLError() + "\"");
	}
	void Window::SetIcon(BitmapView bitmap)
	{
		...
		if (surface == NULL)
		{
			BLAZE_LOG_ERROR("SDL_CreateSurfaceFrom failed. SDL returned error: \"" + GetSDLError() + "\"");
			return;
		}
		if (!SDL_SetWindowIcon((SDL_Window*)handle, surface))
			BLAZE_LOG_ERROR("SDL_SetWindowIcon failed. SDL returned error: \"" + GetSDLError() + "\"");
	...
	void Window::Flash(WindowFlashOperation flashOperation)
	{
		...
		if (!SDL_FlashWindow((SDL_Window*)handle, _flashOperation))
			BLAZE_LOG_ERROR("SDL_FlashWindow failed. SDL returned error: \"{}\"", GetSDLError());
	}
	...
	void Window::SetMouseConfinementRectangle(Recti rect)
	{
		...
		if (rect.w == 0 || rect.h == 0)
		{
			if (!SDL_SetWindowMouseRect((SDL_Window*)handle, nullptr))
				BLAZE_LOG_ERROR("SDL_SetWindowMouseRect failed. SDL returned error: \"" + GetSDLError() + "\"");
		}
	...
	void Window::SetRelativeMouseModeFlag(bool enabled)
	{
		...
		if (!SDL_SetWindowRelativeMouseMode((SDL_Window*)handle, enabled))
			BLAZE_LOG_ERROR("SDL_SetWindowRelativeMouseMode failed. SDL returned error: \"" + GetSDLError() + "\"");
	}
	...
	void Window::SetKeyboardGrabFlag(bool grab)
	{
		...
		if (!SDL_SetWindowKeyboardGrab((SDL_Window*)handle, grab))
			BLAZE_LOG_ERROR("SDL_SetWindowKeyboardGrab failed. SDL returned error: \"" + GetSDLError() + "\"");
	}
	...
	void Window::Raise()
	{
		...
		if (!SDL_RaiseWindow((SDL_Window*)handle))
			BLAZE_LOG_ERROR("SDL_RaiseWindow failed. SDL returned error: \"" + GetSDLError() + "\"");
	}
	void Window::SetDisplayModeForFullscreen(const Display::DisplayMode& displayMode)
	{
		...
		if (!SDL_SetWindowFullscreenMode((SDL_Window*)handle, &_displayMode))
			BLAZE_LOG_ERROR("SDL_SetWindowFullscreenMode failed. SDL returned error: \"" + GetSDLError() + "\"");
	}
	Display::DisplayID Window::GetDisplayIndex()
	{
		...
		if (id == 0)
			BLAZE_LOG_ERROR("SDL_GetDisplayForWindow failed. SDL returned error: \"" + GetSDLError() + "\"");
