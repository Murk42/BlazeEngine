...
namespace Blaze
{
	...
	*/
	...
	concept InsertabloToVirtualMap = std::derived_from<Value, ValueBase> || std::same_as<ValueBase, void>;
	...
	*/
	...
	public:
		...
		*/
		...
		InsertResult Insert(_Key&& key, Value&& value);
