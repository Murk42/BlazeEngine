...
{	
	...
	enum class InputEvent
	{
		...
		KeyUp,				/* void Function(Key) */
		KeyDown,			/* void Function(Key) */
		KeyPressed,			/* void Function(Key) */
		KeyReleased,		/* void Function(Key) */
	...
	{							
		...
		const BLAZE_API KeyState GetKeyState(Key code);
