...
void main()															  
{																		  
	gl_Position = u_MVP * vec4(u_scaling * vec2(geom_pos1[0].x, geom_pos1[0].y), 0, 1);
	frag_uv = vec2(geom_uv1[0].x, geom_uv1[0].y);						  
	frag_pos = u_scaling * vec2(geom_pos1[0].x, geom_pos1[0].y);
	EmitVertex();														  
																		  
	gl_Position = u_MVP * vec4(u_scaling * vec2(geom_pos1[0].x, geom_pos2[0].y), 0, 1);
	frag_uv = vec2(geom_uv1[0].x, geom_uv2[0].y);						  
	frag_pos = u_scaling * vec2(geom_pos1[0].x, geom_pos2[0].y);
	EmitVertex();														  
																		  
	gl_Position = u_MVP * vec4(u_scaling * vec2(geom_pos2[0].x, geom_pos1[0].y), 0, 1);
	frag_uv = vec2(geom_uv2[0].x, geom_uv1[0].y);		
	frag_pos = u_scaling * vec2(geom_pos2[0].x, geom_pos1[0].y);
	EmitVertex();														  
																		  
	gl_Position = u_MVP * vec4(u_scaling * vec2(geom_pos2[0].x, geom_pos2[0].y), 0, 1);
