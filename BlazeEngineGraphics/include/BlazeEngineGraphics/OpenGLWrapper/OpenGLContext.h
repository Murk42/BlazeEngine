...
{	
	...
	namespace Events
	{
		...
		BLAZE_GRAPHICS_API  void AddRenderAreaChangedEventHandler(EventHandler<RenderAreaChanged>&);
		BLAZE_GRAPHICS_API  void RemoveRenderAreaChangedEventHandler(EventHandler<RenderAreaChanged>&);
	}
}