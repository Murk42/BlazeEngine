...
namespace Blaze::FontGlyphRenderers
{
	Bitmap MonochromeFontGlyphRenderer::Render(const FontFace& fontFace, float fontPixelHeight, uint32 glyphIndex)
	{		
	...
	Bitmap AntialiasedFontGlyphRenderer::Render(const FontFace& fontFace, float fontPixelHeight, uint32 glyphIndex)
	{
		FT_Face face = (FT_Face)fontFace.GetHandle();
	...
	Bitmap HorizontalLCDFontGlyphRenderer::Render(const FontFace& fontFace, float fontPixelHeight, uint32 glyphIndex)
	{
		FT_Face face = (FT_Face)fontFace.GetHandle();
		FT_Set_Pixel_Sizes(face, 0, fontPixelHeight);
	...
	Bitmap VerticalLCDFontGlyphRenderer::Render(const FontFace& fontFace, float fontPixelHeight, uint32 glyphIndex)
	{
		FT_Face face = (FT_Face)fontFace.GetHandle();
		FT_Set_Pixel_Sizes(face, 0, fontPixelHeight);
	...
	Bitmap SDFFontGlyphRenderer::Render(const FontFace& fontFace, float fontPixelHeight, uint32 glyphIndex)
	{
		FT_Face face = (FT_Face)fontFace.GetHandle();
		FT_Set_Pixel_Sizes(face, 0, fontPixelHeight);
