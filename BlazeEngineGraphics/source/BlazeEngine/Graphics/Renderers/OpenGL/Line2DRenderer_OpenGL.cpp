...
namespace Blaze::Graphics::OpenGL
{
	...
	{
		auto vert = OpenGL::VertexShader(ShaderSources::line2d_vert);
		auto frag = OpenGL::FragmentShader(ShaderSources::line2d_frag);				
		program.LinkShaders({ &vert, &frag });		

		vb.Allocate(nullptr, VertexBufferSize, Blaze::Graphics::OpenGL::GraphicsBufferMapAccessFlags::Write, Blaze::Graphics::OpenGL::GraphicsBufferMapType::None);
		...
		va.SetFloatVertexAttributeFormat(4, Blaze::Graphics::OpenGL::FloatVertexAttributeType::Float, 1, 40);
	...
	{		
		...
		Blaze::Graphics::OpenGL::Fence fence{ };
		fence.SetFence();
		uintMem offset = 0;
		while (offset != renderCache.vertices.Count())
		{
			...
			void* vbMap = vb.MapBufferRange(0, VertexBufferSize, Blaze::Graphics::OpenGL::GraphicsBufferMapOptions::InvalidateBuffer | Blaze::Graphics::OpenGL::GraphicsBufferMapOptions::ExplicitFlush);
			...
			graphicsContext.RenderPrimitiveArray(Blaze::Graphics::OpenGL::PrimitiveType::Triangles, 0, count);
