...
{
	TextRenderer_OpenGL::TextRenderer_OpenGL(GraphicsContext& graphicsContext, RenderContext& transferRenderContext)
	{
	...
	void TextRenderer_OpenGL::RenderText(RenderContext& context, Framebuffer& target, TextRenderData renderData, std::initializer_list<Semaphore*> waitSemaphores, std::initializer_list<Semaphore*> signalSemaphores)
	{		
