...
namespace Blaze::UI::FontGlyphRenderers
{
	Bitmap MonochromeFontGlyphRenderer::Render(const FontFace& fontFace, float fontPixelHeight, uint32 glyphIndex) const
	{
	...
	Bitmap AntialiasedFontGlyphRenderer::Render(const FontFace& fontFace, float fontPixelHeight, uint32 glyphIndex) const
	{
		FT_Face face = (FT_Face)fontFace.GetHandle();
		FT_Set_Pixel_Sizes(face, 0, static_cast<FT_UInt>(fontPixelHeight));
	...
	Bitmap HorizontalLCDFontGlyphRenderer::Render(const FontFace& fontFace, float fontPixelHeight, uint32 glyphIndex) const
	{
		FT_Face face = (FT_Face)fontFace.GetHandle();
		FT_Set_Pixel_Sizes(face, 0, static_cast<FT_UInt>(fontPixelHeight));
	...
	Bitmap VerticalLCDFontGlyphRenderer::Render(const FontFace& fontFace, float fontPixelHeight, uint32 glyphIndex) const
	{
		FT_Face face = (FT_Face)fontFace.GetHandle();
		FT_Set_Pixel_Sizes(face, 0, static_cast<FT_UInt>(fontPixelHeight));
	...
	Bitmap SDFFontGlyphRenderer::Render(const FontFace& fontFace, float fontPixelHeight, uint32 glyphIndex) const
	{
		FT_Face face = (FT_Face)fontFace.GetHandle();
		FT_Set_Pixel_Sizes(face, 0, static_cast<FT_UInt>(fontPixelHeight));
	...
	Bitmap MSDFFontGlyphRenderer::Render(const FontFace& fontFace, uint32 glyphIndex)
	{
