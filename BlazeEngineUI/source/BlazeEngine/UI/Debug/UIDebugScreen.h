...
namespace Blaze
{
	...
	public:		
		...
		UI::Nodes::TextStyle textStyle0{ .fontManager = &fontManager, .fontName = "default", .fontHeight = 32.0f };
		UI::Nodes::TextStyle textStyle1{ .fontManager = &fontManager, .fontName = "default", .fontHeight = 20.0f };
		UI::Nodes::TextStyle textStyle2{ .fontManager = &fontManager, .fontName = "default", .fontHeight = 12.0f };
		
		UI::Nodes::PanelButtonStyle buttonPanelStyle{ .panelStyle = {.fillColor = 0x404040ff, .borderColor = 0x0, .borderWidth = 0, .cornerRadius = 0 }, .highlightTint = 0xffffff30, .pressedTint = 0x00000050 };

		UI::Nodes::PanelStyle panelStyle{ .fillColor = 0x000000B0, .borderColor = 0x0, .borderWidth = 0, .cornerRadius = 0 };
		...
		UI::Nodes::Panel mouseInfoPanel{ *this, {.position = {3, -3}, .parentPivot = {0, 1}, .pivot = {0, 1}, .size = { 300, 100 }}, {.fillColor = 0x000000D0, .borderColor = 0xffffffff, .borderWidth = 1, .cornerRadius = 0 } };
