#pragma once
#include "BlazeEngineCore/Common/Align.h"
#include "BlazeEngineCore/Container/RawArray.h"
...
namespace Blaze::Graphics
{
	...
	public:
		...
		Rectf SetText(u8StringView text, TextStyleData* textStyleData, float maxLineLength, ResourceRef<TextStyle> defaultTextStyle, const Map<FontAtlasIdentifier, const FontAtlas&>& atlases);
		Rectf SetText(const TextLayoutCacheBase& cache, const Map<FontAtlasIdentifier, const FontAtlas&>& atlases);
	private:
		struct AtlasData
		{
