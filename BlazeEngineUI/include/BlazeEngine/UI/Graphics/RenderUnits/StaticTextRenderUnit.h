...
namespace Blaze::UI
{
	class BLAZE_API StaticTextRenderUnit : public UIRenderUnit<Graphics::TexturedRectRenderer>
	{
	public:
		...
		void Render(const Node& node, Graphics::TexturedRectRenderer& renderer, const UIRenderContext& renderContext) override;
	};
}